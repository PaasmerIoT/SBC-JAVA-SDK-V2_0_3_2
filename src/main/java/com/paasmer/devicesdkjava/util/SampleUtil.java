...
package com.paasmer.devicesdkjava.util;
...
public class SampleUtil {
    ...
    private static final String CertificateFile="beaglebonetest-certificate.pem.crt";
    private static final String PrivateKeyFile="beaglebonetest-private.pem.key";
    ...
    public static String getConfig(String name) {
        ...
        InputStream resource = SampleUtil.class.getResourceAsStream(PropertyFile);
    ...
    private static List<Certificate> loadCertificatesFromFile(final String filename) {
    	try {
    	URL resource = SampleUtil.class.getResource(filename);
       InputStream in=SampleUtil.class.getResourceAsStream(filename);
